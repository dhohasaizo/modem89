...
#define TRC_START_FILL_HEAER_PREPARE(NoBytes)  do{\
                                            kal_char checksum;                                            \
                                            if (lmu_fifo_full) {lmu_data_lost_count++; return;}           \
...
#define TRC_BUFFER_FULL(buffer,offset) \
  ...
  #define TRC_START_FILL(NoBytes)                                               \
    ...
    if (tst_L1Trc_port == uart_port_lmu || g_tst_alc_l1_logging_enable){           \
      if (g_tst_alc_l1_logging_enable)                                             \
  ...
  #define TRC_END_FILL_1w  if (tst_L1Trc_port != uart_port_lmu){                         \
                             if (g_tst_alc_l1_logging_enable){                                \
                               TRC_BUFFER_FULL_ALC_SEND();                               \
                             }else{                                                      \
  ...
  #define TRC_END_FILL_2w  if (tst_L1Trc_port != uart_port_lmu){                         \
                             if (g_tst_alc_l1_logging_enable){                                \
                               TRC_BUFFER_FULL_ALC_SEND();                               \
                             }else{                                                      \
                             TRC_END_FILL_NON_LMU();                                     \
                             ...
                             TRC_LMU_SEND_2W(outBuf);                                    \
                           }                                                             \
                           do{}while(0)

  #undef TRC_END_FILL_3w 
  #define TRC_END_FILL_3w  if (tst_L1Trc_port != uart_port_lmu){                         \
                             if (g_tst_alc_l1_logging_enable){                                \
                               TRC_BUFFER_FULL_ALC_SEND();                               \
                             }else{                                                      \
                             TRC_END_FILL_NON_LMU();                                     \
                             ...
                             TRC_LMU_SEND_3W(outBuf);                                    \
                           }                                                             \
                           do{}while(0)

  #undef TRC_END_FILL_4w 
  #define TRC_END_FILL_4w  if (tst_L1Trc_port != uart_port_lmu){                         \
                             if (g_tst_alc_l1_logging_enable){                                \
                               TRC_BUFFER_FULL_ALC_SEND();                               \
                             }else{                                                      \
                             TRC_END_FILL_NON_LMU();                                     \
                             ...
                             TRC_LMU_SEND_4W(outBuf);                                    \
                           }                                                             \
                           do{}while(0)

  #undef TRC_END_FILL_5w 
  #define TRC_END_FILL_5w  if (tst_L1Trc_port != uart_port_lmu){                         \
                             if (g_tst_alc_l1_logging_enable){                                \
                               TRC_BUFFER_FULL_ALC_SEND();                               \
                             }else{                                                      \
                             TRC_END_FILL_NON_LMU();                                     \
                             ...
                             TRC_LMU_SEND_5W(outBuf);                                    \
                           }                                                             \
                           do{}while(0)

  #undef TRC_END_FILL_6w 
  #define TRC_END_FILL_6w  if (tst_L1Trc_port != uart_port_lmu){                         \
                             if (g_tst_alc_l1_logging_enable){                                \
                               TRC_BUFFER_FULL_ALC_SEND();                               \
                             }else{                                                      \
                             TRC_END_FILL_NON_LMU();                                     \
                             ...
                             TRC_LMU_SEND_6W(outBuf);                                    \
                           }                                                             \
                           do{}while(0)

  #undef TRC_END_FILL_7w 
  #define TRC_END_FILL_7w  if (tst_L1Trc_port != uart_port_lmu){                         \
                             if (g_tst_alc_l1_logging_enable){                                \
                               TRC_BUFFER_FULL_ALC_SEND();                               \
                             }else{                                                      \
                             TRC_END_FILL_NON_LMU();                                     \
