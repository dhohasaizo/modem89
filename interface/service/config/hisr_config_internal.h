...
X_HISR_CONST((HISR_ID_SS_CODE_BEGIN + 2),   LGAHISR,   "LGA_HISR",2,1024,Lga_HisrEntry,KAL_TRUE)
...
X_HISR_CONST((HISR_ID_SS_CODE_BEGIN + 4), BC_HISR, "BC_HISR", 1, 2048, bc_isr_hisr, KAL_TRUE)
...
X_HISR_CONST((HISR_ID_MODEM_CODE_BEGIN + 5),   UL2SEQ_HISR, "UL2SEQ_HISR", 1, 1024, seq_isr_hisr, KAL_TRUE)
#endif
#ifdef  __UMTS_RAT__
...
X_HISR_CONST((HISR_ID_MODEM_CODE_BEGIN + 6),   UL2BCP_HISR,   "UL2BCP_HISR", 1, 512, bcp_isr_hisr, KAL_TRUE)
...
X_HISR_CONST((HISR_ID_MODEM_CODE_BEGIN + 8), HIF_CB_HISR, "HIF_CB_HISR", 0, 1000, ast_hif_cb_hisr, KAL_TRUE)
