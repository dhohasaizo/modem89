...
#define TASK_PRIORITY_UL1C         (KAL_PRIORITY_CLASS1)
...
#ifdef  __UMTS_RAT__
#define TASK_PRIORITY_URR          (KAL_PRIORITY_CLASS2)
...
#else
#define TASK_PRIORITY_DATA         (KAL_PRIORITY_CLASS7 + 9)
#endif
...
/*module_type and mod_task_g*/
task_module_map(TASK_ID_MODEM_2G3G_CODE_TAIL, MOD_MODEM_DUMMY_TAIL)
/*task's parameters*/
task_name("")
task_queue_name("")
task_priority(0 , KAL_TASK_INITIAL_PRIORITY)
