...
#define NVRAM_EF_MINI_LOG_SIZE				510 // keep 2 bytes for checksum
#ifdef __MINI_LOG_ENLARGE_SUPPORT__
#define NVRAM_EF_MINI_LOG_TOTAL				(2 * 1024 * 1020 / NVRAM_EF_MINI_LOG_SIZE) // 2M for each LID
#else
#define NVRAM_EF_MINI_LOG_TOTAL				(10 * 1020 / NVRAM_EF_MINI_LOG_SIZE) // 10K for each LID
#endif
#endif
