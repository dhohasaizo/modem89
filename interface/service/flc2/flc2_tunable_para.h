...
#define FLC2_NPDU_UL_POOL_NUMBER    __MAX_NUM_OF_PPP_DIALUP_SUPPORT__
#define FLC2_NPDU_DL_POOL_NUMBER    FLC2_MAX_PDP_CNTXTS
#elif defined(__MULTIPLE_NDIS_SUPPORT__)
// Number of CCCI-CCMNI channel is 3
#define FLC2_NPDU_UL_POOL_NUMBER    FLC2_MIN(3, __MAX_NUM_OF_NDIS_SUPPORT__)
#define FLC2_NPDU_DL_POOL_NUMBER    FLC2_MAX_PDP_CNTXTS
#else
#define FLC2_NPDU_UL_POOL_NUMBER    1
#define FLC2_NPDU_DL_POOL_NUMBER    1
#endif

#else
#define FLC2_MAX_PDP_CNTXTS         0
#define FLC2_NPDU_UL_POOL_NUMBER    0
#define FLC2_NPDU_DL_POOL_NUMBER    0
#endif

#define FLC2_MAX_NPDU_POOLS_NUM     FLC2_NPDU_DL_POOL_NUMBER
...
#elif defined(__USB_TETHERING__)
...
#else
// FDD
#if defined(__MAC_EHS_SUPPORT__) /* Support latter than R7 */
#define FLC2_NPDU_UL_MAX_GROW  (310 * 1024)
#define FLC2_NPDU_DL_MAX_GROW  (62 * 1024)
#elif defined(__HSUPA_SUPPORT__)
/* HSUPA support, set UL pool to 64KB */
#define FLC2_NPDU_UL_MAX_GROW  (65 * 1024)
#define FLC2_NPDU_DL_MAX_GROW  (44 * 1024)
#elif defined(__LLC_ACK_MODE_SUPPORT__) || (defined(__UMTS_RAT__) && !defined(__LOW_COST_SUPPORT_COMMON__))
/* DPA support or 3G R99 settings */
#define FLC2_NPDU_UL_MAX_GROW  (33 * 1024) 
...
#define FLC2_NPDU_UL_TOTAL_CHUNKS           \
    (FLC2_NPDU_UL_CHUNKS * FLC2_NPDU_UL_POOL_NUMBER)

#define FLC2_NPDU_DL_TOTAL_CHUNKS           \
    (FLC2_NPDU_DL_CHUNKS * FLC2_NPDU_DL_POOL_NUMBER)

#define FLC2_NPDU_UL_POOL_SIZE_TOTAL        \
    FLC2_FIX_SIZE_POOL_SIZE_COUNT(FLC2_MB_2_CHUNK_SIZE, \
        FLC2_NPDU_UL_TOTAL_CHUNKS)

#define FLC2_NPDU_DL_POOL_SIZE_TOTAL        \
    FLC2_FIX_SIZE_POOL_SIZE_COUNT(FLC2_MB_2_CHUNK_SIZE, \
        FLC2_NPDU_DL_TOTAL_CHUNKS)
...
#define FLC2_UT_ONLY_POOL_SIZE      (FLC2_NPDU_DL_POOL_SIZE + 100 * 1024)
...
#define FLC2_MM_BLOCK_10_SIZE (FLC2_PSPDU_UL_POOL_SIZE + \
                               ...
                               FLC2_MM_BLOCK_10_MAX_GROW_SIZE + \
