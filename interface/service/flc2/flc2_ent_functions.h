...
#if (defined(__UMTS_TDD128_MODE__) && !defined(__LOW_COST_SUPPORT_COMMON__))
...
extern void flc2_ent_free_peer_buff_without_pool_id(peer_buff_struct *buff_ptr);
...
extern void flc2_ent_free_peer_buff_internal(flc2_pool_id_enum pool_id,
    flc2_my_peer_buff_struct *buff_ptr, kal_uint8 check_ref_count,
    kal_char *filename, kal_uint32 line);
