...
typedef enum
{
   ...
   FLC_EM_INFO,
    ...
    VT_EM_CALL_STATE_INFO, VT_EM_BEGIN = VT_EM_CALL_STATE_INFO,/* vt_em_call_state_choice */
    ...
    */
   UAS_3G_GENERAL_STATUS_IND_STRUCT_INFO, URR_EM_INFO_BEGIN = UAS_3G_GENERAL_STATUS_IND_STRUCT_INFO,
   ...
   MEME_EM_INFO_UMTS_CELL_STATUS_STRUCT_INFO, MEME_EM_INFO_BEGIN = MEME_EM_INFO_UMTS_CELL_STATUS_STRUCT_INFO,
   ...
   /* __UL2_EM_MODE__ */
   UL2_EM_ADM_POOL_STATUS_IND_STRUCT_INFO, UL2_EM_INFO_BEGIN = UL2_EM_ADM_POOL_STATUS_IND_STRUCT_INFO,
