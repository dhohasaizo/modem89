 ...
 ****************************************************************************/
   ...
   TRC_MSG(SST_PHASE1_441, "In stack_check_msgid_range(), message ID overflow is detected at %Mmsg_type!")
	...
	TRC_MSG(SST_PHASE2_303_8888_P6, "My dear, Task %c%c%c%c%c%c%c%c may be blocked by tasks listed below;")
   ...
   TRC_MSG(SST_SM_SCB_CREATED, "   sm_created : 0x%X")
	...
	/* Event group */
	TRC_MSG(SST_EV_GCB, "Content of semaphore control block as below:")
