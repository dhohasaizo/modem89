 ...
 ****************************************************************************/
   ...
   TRC_MSG(SST_PHASE1_840_PTR_P1, "In kal_release_buffer(), it is detected that the buffer footer is corrupted, it is no longer 0xF2F2F2F2.")
   ...
   TRC_MSG(SST_PHASE1_842_PTR_P1, "In kal_get_buffer(), it is detected that buffer footer is no longer 0xF2F2F2F2. It was previously")
