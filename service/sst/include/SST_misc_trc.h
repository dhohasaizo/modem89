 ...
 ****************************************************************************/
   ...
   TRC_MSG(SST_PHASE1_c01_01, "In kal_evshed_create_pool ( ), dynamic memory allocation failed for total memory size required by a event scheduler.")
   TRC_MSG(SST_PHASE1_c02_FF, "In kal_evshed_create_pool  ( ), system fails to create partitioned-memory pool for an event schedulre.")
