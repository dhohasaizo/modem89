...
typedef enum {
    LAST_MOD_ID = ( MOD_SRV_TAIL + 1 +
    				MOD_MODEM_DUMMY_TAIL - MOD_MODEM_DUMMY_BEGIN + 1 +
    				MOD_MW_DUMMY_TAIL - MOD_MW_DUMMY_BEGIN + 1 + 
    				MOD_DRV_DUMMY_TAIL - MOD_DRV_DUMMY_BEGIN + 1) + 22,
