...
BEGIN_TRACE_MAP(MOD_GPS)
   ...
   /* --------------------------------------------------------------- */
    ...
    TRC_MSG(GPS_AGPS_TRC_OTA_AUTO_RESET_OPTION, "[AGPS] OTA auto reset option: %d")
    TRC_MSG(GPS_AGPS_TRC_OTA_AUTO_RESET_SCHEDULED, "[AGPS] OTA auto reset is scheduled because finished with %Mgps_error_code_enum!")
