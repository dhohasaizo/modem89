...
__attribute__  ((zero_init, section ("CACHED_EXTSRAM_ZI"))) kal_uint32       mdci_trans_log_index[MDCI_MAX_CHANNEL] = {};
__attribute__  ((zero_init, section ("CACHED_EXTSRAM_ZI"))) MDCI_TRANS_LOG   mdci_trans_log_pool[MDCI_MAX_CHANNEL][DebugEntryNo]={};
__attribute__  ((zero_init, section ("CACHED_EXTSRAM_ZI"))) MDCI_BUFF_T      mdci_last_rx_snapshot[MDIF_MAX_PHY]={};
__attribute__  ((zero_init, section ("CACHED_EXTSRAM_ZI"))) kal_uint8        mdci_readindx_for_MD;
__attribute__  ((zero_init, section ("CACHED_EXTSRAM_ZI"))) kal_uint8        mdci_writeindx_for_FC;
__attribute__  ((zero_init, section ("CACHED_EXTSRAM_ZI"))) kal_uint32       mdci_exception_check_write_result;
__attribute__  ((zero_init, section ("CACHED_EXTSRAM_ZI"))) kal_uint32       mdci_exception_info_write_result;
...
__attribute__  ((zero_init, section ("CACHED_EXTSRAM_ZI"))) ERR_LOG_T mdci_err_log[DebugEntryNo] = {};
