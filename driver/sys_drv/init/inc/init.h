...
#elif defined(MT6280) || defined(MT6575) || defined(MT6577) || (defined(MT6589) && defined(__MD1__))
#define GLOBAL_INT_SRAM_STACK_MEM_SIZE (22*1024 + KAL_TIMER_STACK_SIZE)
#elif (defined(MT6589) && defined(__MD2__))
...
#define __attr_init_ro      __section(INIT_RODATA)
