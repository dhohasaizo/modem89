...
#if defined(MT6276) || defined(MT6256) /// afterward, since no VPORT, here we do not provide DMA_PUSH.
#define DMA_TASK_PUSH(ch,data)      while(IS_VFIFO_FULL(ch)); \
                                          DMA_PUSH(ch,data)
...
#define DMA_CON_MASTER_UART1TX      0x04
#define DMA_CON_MASTER_UART1RX      0x05
...
#if defined (MT6250)
typedef enum {
    DMA_CON_MASTER_RESERVED_0,  // 0
    DMA_CON_MASTER_MSDC,        // 1
    DMA_CON_MASTER_SIM,         // 2
    DMA_CON_MASTER_SIM2,        // 3
    DMA_CON_MASTER_USB1TX,      // 4
    DMA_CON_MASTER_USB1RX,      // 5
    DMA_CON_MASTER_USB2TX,      // 6
    DMA_CON_MASTER_USB2RX,      // 7
    DMA_CON_MASTER_UART1TX,     // 8
    DMA_CON_MASTER_UART1RX,     // 9
    DMA_CON_MASTER_UART2TX,     // 10
    DMA_CON_MASTER_UART2RX,     // 11
    DMA_CON_MASTER_UART3TX,     // 12
    DMA_CON_MASTER_UART3RX,     // 13
    DMA_CON_MASTER_BTIFRX,      // 14
    DMA_CON_MASTER_BTIFTX,      // 15
    DMA_CON_MASTER_HIF0,        // 16
    DMA_CON_MASTER_HIF1,        // 17
    DMA_CON_MASTER_RESERVED_18, // 18, AST: i hope reserved_xx is annotated by its index number in total channels.
} DMA_CON_MASTER_CODE;
...
#endif                                 
#endif                                        
#if defined(MT6238)||defined(MT6239)||defined(MT6235)||defined(MT6235B)||defined(MT6268A)||defined(MT6268) || defined(MT6270A) || defined(TK6280)
   #define DMA_CON_MASTER_DSPDMA2       0x11
   #define DMA_CON_MASTER_I2CTX        	0x12
   #define DMA_CON_MASTER_I2CRX        	0x13
   #define DMA_CON_MASTER_MSDC2        	0x14
   ...
   #define DMA_VFIFO_CH_E               17      // end of DMA Virtual fifo  
#elif defined(MT6268) || defined(MT6270A) || defined(TK6280)
   #define DMA_VFIFO_CH_S               11      // start  of DMA Virtual fifo
   ...
   #define __DMA_BT_VIRTUAL_FIFO__
   #endif //   #if defined (__BTMODULE_MT6276__)
#else                                  
   #define DMA_VFIFO_CH_S               11      // start  of DMA Virtual fifo 
   #define DMA_VFIFO_CH_E               14      // end of DMA Virtual fifo    
#endif                                 
   ...
   /* change for 3G projects to obtain higher throughput */
   #define DMA_TX_TRIGGER_LEVEL(n)     ((n)*6/8)    // trigger level of tx vfifo
#else   /* __WCDMA_RAT__ */
   #define DMA_TX_TRIGGER_LEVEL(n)     ((n)/8)      // trigger level of tx vfifo
#endif  /* __UMTS_RAT__ */
...
#define DMA2_SLEEP_ENABLE()     DRVPDN_Enable(PDN_DMA)
#define DMA2_SLEEP_DISABLE()    DRVPDN_Disable(PDN_DMA)

#elif defined(MT6575) || defined (MT6577)
/* AP side DMA  */
//#define DMA2_IRQ_CODE           	IRQ_DMA_AP_CODE   ///only uncommented this line when DMA2 also needs LISR handler; otherwise DMA2 irq is handled by HISR.
...
#define DMA_SLEEP_ENABLE()		DRVPDN_Enable(PDN_DMA)
#define DMA_SLEEP_DISABLE()    DRVPDN_Disable(PDN_DMA)
...
#elif defined(MT6589)
/* AP side DMA  */ //need to confirm 0824
#define DMA2_IRQ_CODE           IRQ_AP_DMA_HIF1_CODE  ///only uncommented this line when DMA2 also needs LISR handler; otherwise DMA2 irq is handled by HISR.
