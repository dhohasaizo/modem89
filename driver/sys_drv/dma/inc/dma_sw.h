...
/**AST: DMA_ALL_CHANNEL & DMA2_ALL_CHANNEL are used for support MULTI_CORE_SHARED_DMA.
 * Thus, only definition of 
 *     DMA_LISR_FUNC[DMA_ALL_CHANNEL], 
 *     DMA_Save_Param[DMA_ALL_CHANNEL] and 
 *     DMA_Owner[DMA_ALL_CHANNEL] depend on it.
 *
 * however, These are all sparse array, and 
 * size should aligned to the maximum index of DMA half-size channel.
 **/

#define DMA_ALL_CHANNEL          4
#define DMA_MAX_CHANNEL          2  //BT and VFF belong to VFF
#define DMA_MAX_FULL_CHANNEL     2  

#define DMA2_ALL_CHANNEL         6
#define DMA2_MAX_CHANNEL         6
...
#define DMA_ALL_CHANNEL          4
#define DMA_MAX_CHANNEL          4  //BT and VFF belong to VFF
#define DMA_MAX_FULL_CHANNEL     2  

//need to confirm 0824
...
typedef enum {
	...
	/*AP side*/
    DMA_HIF1 = 0x84,     //DMA2 need to confirm 0824
    DMA_IDLE
} DMA_Master;
...
typedef enum {
    ...
    DMA_FULLSIZE_TXRINGBUFF, 
    DMA_FULLSIZE_RXRINGBUFF
} DMA_Type;
...
#if defined(MT6575) || defined (MT6280)  || defined(MT6577) || defined(MT6589)
/*AP side*/
