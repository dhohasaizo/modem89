...
//change mcu and dsp share memory to internal memory
#if defined(MT6280) || defined(MT6589)
...
#define __AM_DSP_IN_TASK__ ( defined(MT6280) || defined(MT6589))

// For 3G
//#define __SP3G_PLATFORM__ 

// For 65nm
#define __RELOAD_DSP_COEFF__  ( defined(MT6280) || defined(MT6589))
#define __RELOAD_HW_COEFF__  ( defined(MT6280) || defined(MT6589))
#define WB_SPE_SUPPORT        ( defined(MT6280) || defined(MT6589))
