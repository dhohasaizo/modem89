...
#elif defined(MT6236) || defined(MT6236B) || defined(MT6252) || defined(MT6252H) || defined(MT6256) || defined(MT6255) || defined(MT6589)
const unsigned short Speech_Common_Para[12] = 
{ 
...
{ 
   if( ec )
   {
      *DP_EC_SUPP |= FLAG_DDL_UL_ENTRY;  //MT6280, what is this for, since the sherrif is used to ctrl ul enh via bit 1     
      if( *DSP_UL_NR_CTRL == SPE_IDLE_STATE )
      {
         L1SP_LoadSpeechPara();
