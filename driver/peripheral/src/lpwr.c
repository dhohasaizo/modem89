...
kal_uint16 max_lpwr_module;
    ...
    __attribute__ ((zero_init, section ("READ_WRITE_ZI")))
#elif defined(__EXT_BOOTLOADER__)   
    __attribute__ ((zero_init, section ("EXT_READ_WRITE_ZI")))
#else 
   ...
   */   
      ...
      __attribute__ ((zero_init, section ("CACHEDZI")))
   ...
   #endif
   */   
    #if defined(__MTK_TARGET__) && defined(LPWR_INTERNAL_SRAM)
      __attribute__ ((zero_init, section ("INTERNZI")))
    #endif //#if defined(__MTK_TARGET__) && defined(LPWR_INTERNAL_SRAM)
...
#endif
*/
#if (defined(__MTK_TARGET__) && defined(LPWR_INTERNAL_SRAM) && defined(DRV_MISC_LPWR_INTERNAL_REGION))
