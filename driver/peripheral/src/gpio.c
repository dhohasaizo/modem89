...
*   external_global        
*/
__attribute__ ((section ("INTERNCODE"))) void GPIO_WriteIO_FAST2(char data, kal_uint16 no, kal_uint16 remainder_shift)
{
#if !defined(DRV_GPIO_OFF)
#ifdef DRV_GPIO_6205B_FUNC
 ...
 __attribute__ ((section ("INTERNCODE")))  kal_uint16  get_6280_spec_index( kal_uint16	pin_num)
 	{   
#if !defined(DRV_GPIO_OFF)
#if defined (DRV_GPIO_6280_SPECIAL_SET_REG)
 ...
 __attribute__ ((section ("INTERNCODE"))) kal_bool  Is_6280_SPEC_GPIO( kal_uint16 pin)
 	{
#if !defined(DRV_GPIO_OFF)
#if defined (DRV_GPIO_6280_SPECIAL_SET_REG)
...
#error //chip not support
 ...
 __attribute__ ((section ("INTERNCODE")))  kal_int32 IPC_RPC_GPIO_GetPin(kal_uint8 *GPIOName, kal_uint32 GPIONameLength, kal_uint32 *GPIOPin);
#endif
 /*
 * FUNCTION 														   
 *	 GPIO_MD_InitIO
 ...
 *	 external_global
 */
__attribute__ ((section ("INTERNCODE")))  void GPIO_MD_InitIO(char direction, char port)
 	{   
 ...
 *	 external_global		
 */
__attribute__ ((section ("INTERNCODE"))) void GPIO_MD_WriteIO(char data, char port)
	{
...
__attribute__ ((section ("INTERNCODE")))   void GPIO_MD_ModeSetup(kal_uint16 pin, kal_uint16 conf_dada)
   {
   ...
   *
   */
__attribute__ ((section ("INTERNCODE"))) void GPIO_MD_PullenSetup(kal_uint16 pin, kal_bool enable)
 	{
   ...
   *
   */
__attribute__ ((section ("INTERNCODE")))   void GPIO_MD_PullSelSetup(kal_uint16 pin, kal_bool pull_up)
   	{
   ...
   *
   */
__attribute__ ((section ("INTERNCODE"))) void GPIO_MD_DinvSetup(kal_uint16 pin, kal_bool enable)
	  {
