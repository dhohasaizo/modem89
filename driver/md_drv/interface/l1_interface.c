...
#define  __prifunc                       __attribute__ ((__section__("PRIMARY_ROCODE")))
#else
#define  __prifunc
#endif
...
__prifunc void L1D_HW_TDMA_AUX_TIME_SETUP(kal_uint16 event0, kal_uint16 event1)
{
...
__prifunc kal_uint16 L1D_TDMA_GET_TQCNT( void )
{
   return HW_READ(TQ_CURRENT_COUNT);
}
/* ------------------------------------------------------------------------- */

__prifunc kal_uint16 L1D_HW_TDMA_GET_TQWRAP( void )
{
   return HW_READ(TQ_WRAP);
}
/* ------------------------------------------------------------------------- */

__prifunc kal_uint32 L1D_HW_TDMA_GET_32KCNT( void )
{
...
__prifunc static void MD_DRV_L1D_PWR_SLEEP( void )
{
#if MD_DRV_IS_CHIP_MT6250 || MD_DRV_IS_CHIP_MT6280 || MD_DRV_IS_CHIP_MT6583_MD1 || MD_DRV_IS_CHIP_MT6583_MD2
...
__prifunc static void MD_DRV_L1D_DisableAllIRQ( void )
{
...
__prifunc void MD_DRV_L1D_Exit( void )
{
 ...
 *
 *************************************************************************/
#if MD_DRV_IS_CHIP_MT6276 || MD_DRV_IS_CHIP_MT6573 || MD_DRV_IS_CHIP_MT6575 || MD_DRV_IS_CHIP_MT6250 || MD_DRV_IS_CHIP_MT6280 || MD_DRV_IS_CHIP_MT6583_MD1 || MD_DRV_IS_CHIP_MT6583_MD2
...
#define  CMD_MAGIC_VALUE            0x62760000
   ...
   /* Enable FRC for FM. */
   HW_WRITE( SM_FRC_CON, (CMD_MAGIC_VALUE+0x00000001) );
...
static void FH_set_fhset( unsigned short win_idx, sFHset* _fhset );
   ...
   #if MD_DRV_IS_CHIP_MT6583_MD1 || MD_DRV_IS_CHIP_MT6583_MD2
