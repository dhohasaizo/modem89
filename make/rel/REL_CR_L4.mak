...
include make/rel/REL_COMP_CR_L4.mak

# reset for UCR
CUS_REL_BASE_COMP :=
CUS_REL_BASE_COMP += custom/driver/audio/_Default_BB/MT6589
...
CUS_REL_BASE_COMP += custom/driver/drv/misc_drv/_Default_BB/MT6589
...
CUS_REL_BASE_COMP += driver/cmux/include
CUS_REL_BASE_COMP += driver/cmux/src
...
CUS_REL_BASE_COMP += interface/modem/l1/fdd/internal
...
CUS_REL_BASE_COMP += modem/interface/l1/gsm
...
CUS_REL_BASE_COMP += modem/l4/atci/src
CUS_REL_BASE_COMP += modem/l4/csm
CUS_REL_BASE_COMP += modem/l4/csm/cc/include
CUS_REL_BASE_COMP += modem/l4/csm/cc/src
CUS_REL_BASE_COMP += modem/l4/csm/ss/include
CUS_REL_BASE_COMP += modem/l4/csm/ss/src
...
CUS_REL_BASE_COMP += modem/l4/l4c/src/common
CUS_REL_BASE_COMP += modem/l4/l4c/src/proc
CUS_REL_BASE_COMP += modem/l4/mbci/include
CUS_REL_BASE_COMP += modem/l4/mbci/src
CUS_REL_BASE_COMP += modem/l4/phb/include
CUS_REL_BASE_COMP += modem/l4/phb/src
CUS_REL_BASE_COMP += modem/l4/rac/include
CUS_REL_BASE_COMP += modem/l4/rac/src
CUS_REL_BASE_COMP += modem/l4/smsal/include
CUS_REL_BASE_COMP += modem/l4/smsal/src
CUS_REL_BASE_COMP += modem/l4/smslib/include
CUS_REL_BASE_COMP += modem/l4/smu/include
CUS_REL_BASE_COMP += modem/l4/smu/src
CUS_REL_BASE_COMP += modem/l4/src
CUS_REL_BASE_COMP += modem/l4/tcm/common
CUS_REL_BASE_COMP += modem/l4/tcm/ugtcm
...
CUS_REL_FILES_LIST += make/rel/REL_COMP_CR_L4.mak
CUS_REL_FILES_LIST += make/rel/REL_CR_COMMON.mak
CUS_REL_FILES_LIST += make/rel/REL_CR_L4.mak
