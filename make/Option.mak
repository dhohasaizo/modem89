...
COMMINCDIRS += interface/modem/l1/gsm 
...
COM_DEFS_FOR_MT6167_2G_SKYPA_CUSTOM = MT6167_2G_RF MT6167_2G_SKYPA_CUSTOM
...
COM_DEFS_FOR_MT6167_2G_SKYPA_ALTAI_18_CUSTOM = MT6167_2G_RF MT6167_2G_SKYPA_ALTAI_18_CUSTOM
COM_DEFS_FOR_MT6167_2G_SKYPA_S5_128 = MT6167_2G_RF MT6167_2G_SKYPA_S5_128
COM_DEFS_FOR_MT6167_2G_SKYPA_S5_128_CUSTOM = MT6167_2G_RF MT6167_2G_SKYPA_S5_128_CUSTOM
...
ifdef PMIC
  ...
  PMIC_MT6320_SUPPORT_PLATFORM = MT6589
...
NEED_ADD_PMIC_COMPILE_LIST = MT6223PMU MT6238PMU MT6235PMU MT6236PMU MT6573PMU MT6575PMU MT6577PMU MT6305 MT6318 MT6326 MT6253PMU MT6253ELPMU MT6252PMU MT6326_CCCI MT6251PMU MT6276PMU MT6256PMU MT6921PMU MT6329 MT6255PMU MT6922PMU MT6250PMU MT6327 MT6320
...
ifdef EDGE_SUPPORT
  ifeq ($(strip $(EDGE_SUPPORT)),TRUE)
    EDGE_SUPPORT_PLATFORM = MT6575 MT6577 MT6280 MT6589
    ...
    L1_EPSK_TX_SUPPORT_RF_MODULE = MT6140D_RF AD6546_RF SKY74137_RF SKY74045_RF MT6256RF_RF MT6162_RF MT6163_2G_RF MT6168_2G_RF MT6280RF_2G_RF MT6167_2G_RF
...
ifeq ($(strip $(AMRWB_LINK_SUPPORT)),TRUE)
  AMRWB_LINK_SUPPORT_PLATFORM = MT6575 MT6577 MT6280 MT6589
...
CENTRALIZED_SLEEP_MANAGER_PLATFORM = MT6575 MT6280 MT6577 MT6589
...
MULTI_LNA_MODE_CALIBRATION_SUPPORT_PLATFORM = MT6575 MT6280 MT6577 MT6589
...
2G_TX_POWER_CONTROL_SUPPORT_PLATFORM = MT6575 MT6577 MT6280 MT6589
...
ifdef MOBILE_BROADBAND
  ifeq ($(strip $(MOBILE_BROADBAND)),MBIM)
    ifeq ($(filter L1S BASIC UDVT,$(TEST_LOAD_TYPE)),)
      COM_DEFS     += __NDIS_SUPPORT__ __UPS_SUPPORT__ __MBIM_SUPPORT__
      COMPLIST     += ups
      ifeq ($(filter cmux,$(COMPLIST)),)
        COMPLIST     += cmux
      endif
...
32K_CRYSTAL_REMOVAL_SUPPORT_PLATFORM = MT6280 MT6589 
QUERY_32K_CRYSTAL_FROM_MD_PLATFORM = MT6280
QUERY_32K_CRYSTAL_FROM_AP_PLATFORM = MT6589
...
ifeq ($(strip $(2G_TX_AUTO_CAL_ENHANCEMENT_SUPPORT)),TRUE)
   COM_DEFS += __2G_TX_AUTO_CAL_ITERATION_SUPPORT__
endif
