...
UL1_HS_PLUS_PLATFORM = TK6280 MT6280 MT6589
ifneq ($(strip $(UTRAN_MODE_SUPPORT)),NONE)
  UL1_SUPPORT = TRUE
else
  ifeq ($(strip $(TEST_LOAD_TYPE)),L1S)
...
COMMINCDIRS    +=    interface/service/stacklib \
                     ...
                     interface/modem/l1/gsm interface/modem/l1/fdd/external interface/modem/l1/tdd \
...
ifeq ($(strip $(L1_UMTS)),TRUE)
  ifneq ($(strip $(UTRAN_MODE_SUPPORT)),NONE)
    ifeq ($(strip $(L1_WCDMA)),TRUE)
      COMMINCDIRS += interface/modem/l1/gsm interface/modem/l1/fdd/external
    endif
  endif
endif
