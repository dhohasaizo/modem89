...
/****************************/
	...
	#define UL1I_TRC_PS_Result(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x08)!=0 )\
			L1TRC_Send_UL1I_TRC_PS_Result((unsigned char)(v1));\
} while(0)
#else
	...
	#define UL1I_TRC_PS_SortedFreq(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x08)!=0 )\
			L1TRC_Send_UL1I_TRC_PS_SortedFreq((short)(v1), (char)(v2));\
} while(0)
#else
	...
	#define UL1I_TRC_FS_Result(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x08)!=0 )\
			L1TRC_Send_UL1I_TRC_FS_Result((short)(v1), (char)(v2));\
} while(0)
#else
	...
	#define UL1I_TRC_FS_State(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x08)!=0 )\
			L1TRC_Send_UL1I_TRC_FS_State((char)(v1), (char)(v2));\
} while(0)
#else
	...
	#define UL1T_TRC_FS_Start(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x08)!=0 )\
			L1TRC_Send_UL1T_TRC_FS_Start((char)(v1), (char)(v2));\
} while(0)
#else
	...
	#define UL1T_TRC_FS_Suspend() do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x08)!=0 )\
			L1TRC_Send_UL1T_TRC_FS_Suspend();\
} while(0)
#else
	...
	#define UL1T_TRC_ECS_Start(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x08)!=0 )\
			L1TRC_Send_UL1T_TRC_ECS_Start((short)(v1));\
} while(0)
#else
	...
	#define UL1I_TRC_ECS_InternalStop() do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x08)!=0 )\
			L1TRC_Send_UL1I_TRC_ECS_InternalStop();\
} while(0)
#else
	...
	#define UL1I_TRC_ECS_Status(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x08)!=0 )\
			L1TRC_Send_UL1I_TRC_ECS_Status((char)(v1));\
} while(0)
#else
	...
	#define UL1I_TRC_ECS_Result(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x08)!=0 )\
			L1TRC_Send_UL1I_TRC_ECS_Result((short)(v1), (char)(v2));\
} while(0)
#else
	...
	#define UL1I_TRC_FS_BeforeGetPendingResult(v1, v2, v3, v4, v5) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x08)!=0 )\
			L1TRC_Send_UL1I_TRC_FS_BeforeGetPendingResult((short)(v1), (char)(v2), (short)(v3), (char)(v4), (char)(v5));\
} while(0)
#else
	...
	#define UL1I_TRC_FS_AfterGetPendingResult(v1, v2, v3, v4, v5) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x08)!=0 )\
			L1TRC_Send_UL1I_TRC_FS_AfterGetPendingResult((short)(v1), (char)(v2), (short)(v3), (char)(v4), (char)(v5));\
} while(0)
#else
	...
	#define UL1I_TRC_FS_AfterResume(v1, v2, v3, v4, v5) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x08)!=0 )\
			L1TRC_Send_UL1I_TRC_FS_AfterResume((short)(v1), (char)(v2), (short)(v3), (char)(v4), (char)(v5));\
} while(0)
#else
	...
	#define UL1I_TRC_HFS_DBG(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x08)!=0 )\
			L1TRC_Send_UL1I_TRC_HFS_DBG((short)(v1), (short)(v2));\
} while(0)
#else
	...
	#define UL1I_TRC_HFS_DBG2(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x08)!=0 )\
			L1TRC_Send_UL1I_TRC_HFS_DBG2((short)(v1), (short)(v2));\
} while(0)
#else
	...
	#define UL1I_TRC_Get_ULDCHData(v1, v2, v3, v4, v5) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x80)!=0 )\
			L1TRC_Send_UL1I_TRC_Get_ULDCHData((short)(v1), (char)(v2), (char)(v3), (short)(v4), (char)(v5));\
} while(0)
#else
	...
	#define UL1I_TRC_Get_ULDCHTRCHData(v1, v2, v3, v4) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x80)!=0 )\
			L1TRC_Send_UL1I_TRC_Get_ULDCHTRCHData((char)(v1), (short)(v2), (short)(v3), (short)(v4));\
} while(0)
#else
	...
	#define UL1I_TRC_StartULDCh(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x80)!=0 )\
			L1TRC_Send_UL1I_TRC_StartULDCh((short)(v1), (char)(v2));\
} while(0)
#else
	...
	#define UL1I_TRC_TxStatus(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x80)!=0 )\
			L1TRC_Send_UL1I_TRC_TxStatus((char)(v1));\
} while(0)
#else
	...
	#define UL1I_TRC_UL_Timer_TFC_CB(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x80)!=0 )\
			L1TRC_Send_UL1I_TRC_UL_Timer_TFC_CB((short)(v1));\
} while(0)
#else
	...
	#define UL1I_TRC_UL_Timer_Data_CB(v1, v2, v3) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x80)!=0 )\
			L1TRC_Send_UL1I_TRC_UL_Timer_Data_CB((short)(v1), (short)(v2), (short)(v3));\
} while(0)
#else
	...
	#define UL1T_TRC_Report_ULCB_Data(v1, v2, v3) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x80)!=0 )\
			L1TRC_Send_UL1T_TRC_Report_ULCB_Data((short)(v1), (short)(v2), (short)(v3));\
} while(0)
#else
	...
	#define UL1T_TRC_Report_ULCB_TFC(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x80)!=0 )\
			L1TRC_Send_UL1T_TRC_Report_ULCB_TFC((short)(v1));\
} while(0)
#else
	...
	#define UL1I_TRC_ULDCH_next_timer_delay(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x80)!=0 )\
			L1TRC_Send_UL1I_TRC_ULDCH_next_timer_delay((char)(v1));\
} while(0)
#else
	...
	#define UL1I_TRC_ULDCH_UL1D_Intf(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x80)!=0 )\
			L1TRC_Send_UL1I_TRC_ULDCH_UL1D_Intf((char)(v1));\
} while(0)
#else
	...
	#define UL1I_TRC_ULDCH_Set_MAC_Event(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x80)!=0 )\
			L1TRC_Send_UL1I_TRC_ULDCH_Set_MAC_Event((char)(v1));\
} while(0)
#else
	...
	#define UL1I_TRC_Get_DLDCHData(v1, v2, v3) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1I_TRC_Get_DLDCHData((short)(v1), (char)(v2), (short)(v3));\
} while(0)
#else
	...
	#define UL1I_TRC_Get_DLDCHTRCHData(v1, v2, v3) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1I_TRC_Get_DLDCHTRCHData((char)(v1), (short)(v2), (short)(v3));\
} while(0)
#else
	...
	#define UL1I_TRC_RefDCH(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1I_TRC_RefDCH((char)(v1));\
} while(0)
#else
	...
	#define UL1I_TRC_RefDCHCFN(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1I_TRC_RefDCHCFN((long)(v1), (short)(v2));\
} while(0)
#else
	...
	#define UL1I_TRC_DLSync_State(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1I_TRC_DLSync_State((char)(v1));\
} while(0)
#else
	...
	#define UL1I_TRC_DLSync_Qin(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1I_TRC_DLSync_Qin((short)(v1), (short)(v2));\
} while(0)
#else
	...
	#define UL1I_TRC_New_DPCH_Type(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1I_TRC_New_DPCH_Type((char)(v1), (char)(v2));\
} while(0)
#else
	...
	#define UL1I_TRC_DPCH_Type(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1I_TRC_DPCH_Type((char)(v1));\
} while(0)
#else
	...
	#define UL1T_TRC_ReconfigDCH(v1, v2, v3, v4, v5, v6, v7) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1T_TRC_ReconfigDCH((short)(v1), (short)(v2), (char)(v3), (char)(v4), (char)(v5), (short)(v6), (char)(v7));\
} while(0)
#else
	...
	#define UL1T_TRC_ReconfigDCH_ASAP(v1, v2, v3) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1T_TRC_ReconfigDCH_ASAP((short)(v1), (short)(v2), (short)(v3));\
} while(0)
#else
	...
	#define UL1T_TRC_LoopMode2(v1, v2, v3) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1T_TRC_LoopMode2((short)(v1), (short)(v2), (char)(v3));\
} while(0)
#else
	...
	#define UL1T_TRC_ASU(v1, v2, v3, v4, v5) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1T_TRC_ASU((short)(v1), (short)(v2), (char)(v3), (char)(v4), (short)(v5));\
} while(0)
#else
	...
	#define UL1I_TRC_DL_DCHQual(v1, v2, v3, v4, v5, v6) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1I_TRC_DL_DCHQual((short)(v1), (short)(v2), (short)(v3), (short)(v4), (short)(v5), (short)(v6));\
} while(0)
#else
	...
	#define UL1I_TRC_DL_CRC_Value(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1I_TRC_DL_CRC_Value((unsigned long)(v1));\
} while(0)
#else
	...
	#define UL1I_TRC_DL_Sync_Type(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1I_TRC_DL_Sync_Type((short)(v1), (short)(v2));\
} while(0)
#else
	...
	#define UL1I_TRC_DL_Sync_Info(v1, v2, v3, v4) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1I_TRC_DL_Sync_Info((char)(v1), (short)(v2), (short)(v3), (short)(v4));\
} while(0)
#else
	...
	#define UL1T_TRC_DLSync_Config(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1T_TRC_DLSync_Config((char)(v1), (char)(v2));\
} while(0)
#else
	...
	#define UL1T_TRC_ReconfigDCH_TTI(v1, v2, v3, v4, v5, v6) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1T_TRC_ReconfigDCH_TTI((short)(v1), (short)(v2), (short)(v3), (short)(v4), (short)(v5), (short)(v6));\
} while(0)
#else
	...
	#define UL1T_TRC_ReconfigDCH_TGPS(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1T_TRC_ReconfigDCH_TGPS((short)(v1), (short)(v2));\
} while(0)
#else
	...
	#define UL1T_TRC_Modify_Abort(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x40)!=0 )\
			L1TRC_Send_UL1T_TRC_Modify_Abort((unsigned short)(v1), (unsigned short)(v2));\
} while(0)
#else
...
#if defined(L1_CATCHER)
	#define UL1I_TRC_FACH_Start() do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x02)!=0 )\
			L1TRC_Send_UL1I_TRC_FACH_Start();\
} while(0)
#else
	#define UL1I_TRC_FACH_Start()
#endif

#if defined(L1_CATCHER)
	#define UL1I_TRC_FMO(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x02)!=0 )\
			L1TRC_Send_UL1I_TRC_FMO((char)(v1));\
} while(0)
#else
	...
	#define UL1T_TRC_FMO_Config(v1, v2, v3, v4, v5, v6, v7) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x02)!=0 )\
			L1TRC_Send_UL1T_TRC_FMO_Config((char)(v1), (char)(v2), (char)(v3), (char)(v4), (char)(v5), (char)(v6), (short)(v7));\
} while(0)
#else
	...
	#define UL1I_TRC_FACH_Data(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x02)!=0 )\
			L1TRC_Send_UL1I_TRC_FACH_Data((short)(v1));\
} while(0)
#else
	...
	#define UL1I_TRC_DRX_GAP(v1, v2, v3) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x02)!=0 )\
			L1TRC_Send_UL1I_TRC_DRX_GAP((char)(v1), (char)(v2), (char)(v3));\
} while(0)
#else
	...
	#define UL1T_TRC_SCS_Start(v1, v2, v3, v4) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x10)!=0 )\
			L1TRC_Send_UL1T_TRC_SCS_Start((short)(v1), (short)(v2), (char)(v3), (char)(v4));\
} while(0)
#else
	...
	#define UL1I_TRC_SCS_State(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x10)!=0 )\
			L1TRC_Send_UL1I_TRC_SCS_State((char)(v1));\
} while(0)
#else
	...
	#define UL1I_TRC_SCS_Result(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[3]&0x10)!=0 )\
			L1TRC_Send_UL1I_TRC_SCS_Result((short)(v1));\
} while(0)
#else
	...
	#define UL1I_TRC_PCH_Status(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x01)!=0 )\
			L1TRC_Send_UL1I_TRC_PCH_Status((char)(v1));\
} while(0)
#else
	...
	#define UL1T_TRC_ReconfigPCH(v1, v2, v3) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x01)!=0 )\
			L1TRC_Send_UL1T_TRC_ReconfigPCH((short)(v1), (short)(v2), (char)(v3));\
} while(0)
#else
	...
	#define UL1I_TRC_PCH_drx_cycle2_life(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x01)!=0 )\
			L1TRC_Send_UL1I_TRC_PCH_drx_cycle2_life((short)(v1));\
} while(0)
#else
	...
	#define UL1I_TRC_PCH_SmartPagingState(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x01)!=0 )\
			L1TRC_Send_UL1I_TRC_PCH_SmartPagingState((char)(v1), (short)(v2));\
} while(0)
#else
	...
	#define UL1I_TRC_PCH_SmartPagingLog(v1, v2, v3, v4, v5, v6, v7, v8) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x01)!=0 )\
			L1TRC_Send_UL1I_TRC_PCH_SmartPagingLog((char)(v1), (char)(v2), (short)(v3), (short)(v4), (short)(v5), (char)(v6), (short)(v7), (short)(v8));\
} while(0)
#else
	...
	#define UL1I_TRC_PCH_SmartCSState(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x01)!=0 )\
			L1TRC_Send_UL1I_TRC_PCH_SmartCSState((char)(v1));\
} while(0)
#else
	...
	#define UL1T_TRC_PCH_SmartCSLog(v1, v2, v3, v4, v5, v6, v7, v8, v9) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x01)!=0 )\
			L1TRC_Send_UL1T_TRC_PCH_SmartCSLog((char)(v1), (char)(v2), (short)(v3), (short)(v4), (short)(v5), (char)(v6), (short)(v7), (short)(v8), (short)(v9));\
} while(0)
#else
	...
	#define UL1I_TRC_PCH_SmartCSSkip(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x01)!=0 )\
			L1TRC_Send_UL1I_TRC_PCH_SmartCSSkip((char)(v1));\
} while(0)
#else
	...
	#define UL1T_TRC_TxAccess(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x04)!=0 )\
			L1TRC_Send_UL1T_TRC_TxAccess((short)(v1), (char)(v2));\
} while(0)
#else
	...
	#define UL1T_TRC_RAChData(v1, v2, v3, v4, v5) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x04)!=0 )\
			L1TRC_Send_UL1T_TRC_RAChData((short)(v1), (short)(v2), (char)(v3), (short)(v4), (short)(v5));\
} while(0)
#else
	...
	#define UL1I_TRC_RACH_ASCSetting(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x04)!=0 )\
			L1TRC_Send_UL1I_TRC_RACH_ASCSetting((short)(v1), (short)(v2));\
} while(0)
#else
	...
	#define UL1I_TRC_Get_Access_Slot(v1, v2, v3, v4, v5) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x04)!=0 )\
			L1TRC_Send_UL1I_TRC_Get_Access_Slot((char)(v1), (short)(v2), (char)(v3), (char)(v4), (char)(v5));\
} while(0)
#else
	...
	#define UL1I_TRC_RACH_Start(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x04)!=0 )\
			L1TRC_Send_UL1I_TRC_RACH_Start((long)(v1));\
} while(0)
#else
	...
	#define UL1T_TRC_RACH_NextASS(v1, v2) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x04)!=0 )\
			L1TRC_Send_UL1T_TRC_RACH_NextASS((short)(v1), (long)(v2));\
} while(0)
#else
	...
	#define UL1I_TRC_TxAccess(v1, v2, v3, v4) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x04)!=0 )\
			L1TRC_Send_UL1I_TRC_TxAccess((char)(v1), (long)(v2), (char)(v3), (short)(v4));\
} while(0)
#else
	...
	#define UL1I_TRC_DelayTxAccess_CCM(v1, v2, v3, v4) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x04)!=0 )\
			L1TRC_Send_UL1I_TRC_DelayTxAccess_CCM((char)(v1), (short)(v2), (short)(v3), (long)(v4));\
} while(0)
#else
	...
	#define UL1I_TRC_DelayTxAccess_FMO(v1, v2, v3) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x04)!=0 )\
			L1TRC_Send_UL1I_TRC_DelayTxAccess_FMO((short)(v1), (short)(v2), (long)(v3));\
} while(0)
#else
	...
	#define UL1AC_TRC_EvtReport(v1) do {\
		if(UL1C_PRI1_Trace_Filter[0]==1 && (UL1C_PRI1_Trace_Filter[4]&0x08)!=0 )\
			L1TRC_Send_UL1AC_TRC_EvtReport((char)(v1));\
} while(0)
#else
...
void L1TRC_Send_UL1I_TRC_FACH_Start(void);
...
#define ChkL1MsgFltr_UL1I_TRC_FACH_Start()	ChkL1ClsFltr_UL1C_PRI1_UL1C_FACH_H()
