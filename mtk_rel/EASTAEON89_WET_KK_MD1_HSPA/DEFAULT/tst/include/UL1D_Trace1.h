...
/****************************/
	...
	#define UL1D_TRC_STATE_MACHINE(v1, v2, v3) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_STATE_MACHINE((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_PICH_STATE_MACHINE(v1, v2, v3) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_PICH_STATE_MACHINE((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_RXBRP_STATE(v1, v2) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_RXBRP_STATE((char)(v1), (unsigned char)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_UL_TGPS_INFO(v1, v2, v3) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_UL_TGPS_INFO((unsigned char)(v1), (unsigned short)(v2), (unsigned char)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_DL_TGPS_INFO(v1, v2, v3) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_DL_TGPS_INFO((unsigned char)(v1), (unsigned short)(v2), (unsigned char)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_RACH_PREAMBLE_PARAMETERS(v1, v2, v3, v4, v5) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x08)!=0 )\
			L1TRC_Send_UL1D_TRC_RACH_PREAMBLE_PARAMETERS((unsigned char)(v1), (unsigned long)(v2), (unsigned char)(v3), (char)(v4), (char)(v5));\
} while(0)
#else
	...
	#define UL1D_TRC_RACH_INIT_POWER_PARAM(v1, v2, v3, v4) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x08)!=0 )\
			L1TRC_Send_UL1D_TRC_RACH_INIT_POWER_PARAM((char)(v1), (char)(v2), (short)(v3), (char)(v4));\
} while(0)
#else
	...
	#define UL1D_TRC_RACH_PREAMBLE_TRANSMIT(v1, v2, v3, v4) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x08)!=0 )\
			L1TRC_Send_UL1D_TRC_RACH_PREAMBLE_TRANSMIT((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v4));\
} while(0)
#else
	...
	#define UL1D_TRC_RACH_SEND_REPORT(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x10)!=0 )\
			L1TRC_Send_UL1D_TRC_RACH_SEND_REPORT((unsigned char)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_AICH_DEBUG(v1, v2, v3) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x10)!=0 )\
			L1TRC_Send_UL1D_TRC_AICH_DEBUG((unsigned short)(v1), (unsigned short)(v2), (unsigned long)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_UPDATE_AICH_TH(v1, v2, v3, v4, v5) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x20)!=0 )\
			L1TRC_Send_UL1D_TRC_UPDATE_AICH_TH((short)(v1), (short)(v2), (short)(v3), (short)(v4), (unsigned long)(v5));\
} while(0)
#else
	...
	#define UL1D_TRC_AICH_RESULT(v1, v2, v3) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x08)!=0 )\
			L1TRC_Send_UL1D_TRC_AICH_RESULT((unsigned char)(v1), (unsigned short)(v2), (unsigned short)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_AICH_NO_AI_INT(v1, v2, v3) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x08)!=0 )\
			L1TRC_Send_UL1D_TRC_AICH_NO_AI_INT((unsigned char)(v1), (unsigned char)(v2), (char)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_FACH_FMO(v1, v2) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_FACH_FMO((unsigned char)(v1), (unsigned char)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_FACH_RXCRP_DELAY_START(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_FACH_RXCRP_DELAY_START((char)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_SFN_START(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_SFN_START((long)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_SFN_DETECTED(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_SFN_DETECTED((unsigned char)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_SFN_TRY_CNT(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_SFN_TRY_CNT((short)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_SFN_REPORT_RESULT(v1, v2, v3, v4, v5) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_SFN_REPORT_RESULT((short)(v1), (short)(v2), (char)(v3), (long)(v4), (short)(v5));\
} while(0)
#else
	...
	#define UL1D_TRC_BCH_START_PARAM(v1, v2, v3, v4, v5, v6) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_BCH_START_PARAM((unsigned short)(v1), (unsigned short)(v2), (long)(v3), (long)(v4), (short)(v5), (char)(v6));\
} while(0)
#else
	...
	#define UL1D_TRC_BCH_MPS_TRIGGER(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_BCH_MPS_TRIGGER((unsigned char)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_BCH_STATE_INFO(v1, v2) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_BCH_STATE_INFO((unsigned char)(v1), (unsigned char)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_CMB_EN(v1, v2, v3) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_CMB_EN((char)(v1), (char)(v2), (unsigned char)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_CODEGEN_RL0(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_CODEGEN_RL0((unsigned short)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_TXBRP_TF(v1, v2, v3) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_UL1D_TRC_TXBRP_TF((unsigned char)(v1), (unsigned short)(v2), (unsigned short)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_TXBRP_START_TIME(v1, v2, v3) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_TXBRP_START_TIME((unsigned short)(v1), (unsigned char)(v2), (unsigned short)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_TXBRP_DONE_TIME(v1, v2, v3) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_TXBRP_DONE_TIME((unsigned short)(v1), (unsigned char)(v2), (unsigned short)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_TXBRP_ENC_TIME(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_UL1D_TRC_TXBRP_ENC_TIME((unsigned short)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_CHEST_SPEED(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_CHEST_SPEED((unsigned char)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_PICH_RESULT(v1, v2, v3) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x40)!=0 )\
			L1TRC_Send_UL1D_TRC_PICH_RESULT((unsigned char)(v1), (short)(v2), (unsigned short)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_PICH_SKIP(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x40)!=0 )\
			L1TRC_Send_UL1D_TRC_PICH_SKIP((unsigned short)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_PICH_PI_POSITION(v1, v2, v3, v4, v5) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x40)!=0 )\
			L1TRC_Send_UL1D_TRC_PICH_PI_POSITION((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), (unsigned short)(v4), (unsigned char)(v5));\
} while(0)
#else
	...
	#define UL1D_TRC_SRCHR_PI_DECODE(v1, v2, v3, v4, v5) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x40)!=0 )\
			L1TRC_Send_UL1D_TRC_SRCHR_PI_DECODE((long)(v1), (unsigned short)(v2), (unsigned short)(v3), (unsigned short)(v4), (unsigned short)(v5));\
} while(0)
#else
	...
	#define UL1D_TRC_SRCHR_PI_SCHEDULE(v1, v2, v3, v4, v5) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x40)!=0 )\
			L1TRC_Send_UL1D_TRC_SRCHR_PI_SCHEDULE((short)(v1), (long)(v2), (long)(v3), (short)(v4), (short)(v5));\
} while(0)
#else
	...
	#define UL1D_TRC_TFCI_STATE(v1, v2, v3, v4) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_TFCI_STATE((char)(v1), (char)(v2), (short)(v3), (unsigned short)(v4));\
} while(0)
#else
	...
	#define UL1D_TRC_CMB_ICHCON(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_CMB_ICHCON((unsigned short)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_SPEST_STA(v1, v2) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_SPEST_STA((unsigned char)(v1), (unsigned char)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_SPEST_RESULT(v1, v2, v3, v4, v5) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_SPEST_RESULT((short)(v1), (short)(v2), (short)(v3), (short)(v4), (short)(v5));\
} while(0)
#else
	...
	#define UL1D_TRC_RXBRP_TFCI_OUT_OF_RANGE(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[2]&0x08)!=0 )\
			L1TRC_Send_UL1D_TRC_RXBRP_TFCI_OUT_OF_RANGE((unsigned short)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_HWTPC_SLOTMASK(v1, v2) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x80)!=0 )\
			L1TRC_Send_UL1D_TRC_HWTPC_SLOTMASK((unsigned short)(v1), (unsigned short)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_HWTPC_SLOT_FORMAT(v1, v2) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[2]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_HWTPC_SLOT_FORMAT((unsigned long)(v1), (unsigned long)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_HWTPC_INFO(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x80)!=0 )\
			L1TRC_Send_UL1D_TRC_HWTPC_INFO((short)(v1), (short)(v2), (short)(v3), (short)(v4), (short)(v5), (short)(v6), (short)(v7), (short)(v8), (short)(v9), (short)(v10), (short)(v11), (short)(v12), (short)(v13), (short)(v14), (short)(v15));\
} while(0)
#else
	...
	#define UL1D_TRC_HWTPC_DBG(v1, v2, v3, v4) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x80)!=0 )\
			L1TRC_Send_UL1D_TRC_HWTPC_DBG((unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
} while(0)
#else
	...
	#define UL1D_TRC_HWTPC_PWR(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x80)!=0 )\
			L1TRC_Send_UL1D_TRC_HWTPC_PWR((char)(v1), (char)(v2), (char)(v3), (char)(v4), (char)(v5), (char)(v6), (char)(v7), (char)(v8), (char)(v9), (char)(v10), (char)(v11), (char)(v12), (char)(v13), (char)(v14), (char)(v15));\
} while(0)
#else
	...
	#define UL1D_TRC_HWTPC_PWR_RF(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x80)!=0 )\
			L1TRC_Send_UL1D_TRC_HWTPC_PWR_RF((char)(v1), (char)(v2), (char)(v3), (char)(v4), (char)(v5), (char)(v6), (char)(v7), (char)(v8), (char)(v9), (char)(v10), (char)(v11), (char)(v12), (char)(v13), (char)(v14), (char)(v15));\
} while(0)
#else
	...
	#define UL1D_TRC_HWTPC_PWR_MAX_MIN(v1, v2, v3, v4, v5) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[2]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_HWTPC_PWR_MAX_MIN((char)(v1), (char)(v2), (char)(v3), (char)(v4), (short)(v5));\
} while(0)
#else
	...
	#define UL1D_TRC_HWTPC_CMD(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[2]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_HWTPC_CMD((unsigned long)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_HWTPC_CMD2(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x80)!=0 )\
			L1TRC_Send_UL1D_TRC_HWTPC_CMD2((short)(v1), (short)(v2), (short)(v3), (short)(v4), (short)(v5), (short)(v6), (short)(v7), (short)(v8), (short)(v9), (short)(v10), (short)(v11), (short)(v12), (short)(v13), (short)(v14), (short)(v15));\
} while(0)
#else
	...
	#define UL1D_TRC_32KLESS_TIMING_ERROR_VALID(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_32KLESS_TIMING_ERROR_VALID((unsigned char)(v1));\
} while(0)
#else
...
#if defined(L1_CATCHER)
	#define UL1D_TRC_32KLESS_ACS_START() do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_32KLESS_ACS_START();\
} while(0)
#else
	#define UL1D_TRC_32KLESS_ACS_START()
#endif

#if defined(L1_CATCHER)
	#define UL1D_TRC_32KLESS_TIMING_ERROR(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_32KLESS_TIMING_ERROR((short)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_32KLESS_DIVIDER(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_32KLESS_DIVIDER((unsigned long)(v1));\
} while(0)
#else
...
#if defined(L1_CATCHER)
	#define UL1D_TRC_32KLESS_FREQ_OFFSET(v1) do {\
		if(UL1D_SEC_Trace_Filter[0]==1 && (UL1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_32KLESS_FREQ_OFFSET((long)(v1));\
} while(0)
#else
	#define UL1D_TRC_32KLESS_FREQ_OFFSET(v1)
#endif
...
#define ChkL1MsgFltr_UL1D_TRC_32KLESS_ACS_START()	ChkL1ClsFltr_UL1D_SEC_SM_H()
...
#define ChkL1MsgFltr_UL1D_TRC_32KLESS_FREQ_OFFSET()	ChkL1ClsFltr_UL1D_SEC_SM_H()
