...
/****************************/
	...
	#define UL1D_TRC_MEAS_SCHDL_STATE_REQ(v1, v2, v3) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_SCHDL_STATE_REQ((short)(v1), (unsigned char)(v2), (unsigned short)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_SCHDL_SCHEDULING(v1, v2, v3, v4, v5) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_SCHDL_SCHEDULING((short)(v1), (char)(v2), (char)(v3), (unsigned short)(v4), (char)(v5));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_MPS_START(v1, v2, v3, v4, v5) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_MPS_START((char)(v1), (char)(v2), (char)(v3), (unsigned char)(v4), (char)(v5));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_MEAS_START(v1, v2, v3, v4, v5) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_MEAS_START((char)(v1), (char)(v2), (char)(v3), (char)(v4), (char)(v5));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_MEAS_CELL_INFO(v1, v2, v3, v4, v5) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_MEAS_CELL_INFO((short)(v1), (short)(v2), (short)(v3), (short)(v4), (short)(v5));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_RPT_CELL_INFO(v1, v2, v3, v4) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_RPT_CELL_INFO((short)(v1), (long)(v2), (short)(v3), (short)(v4));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_MEAS_FINISH(v1, v2, v3) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_MEAS_FINISH((char)(v1), (char)(v2), (char)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_CS3_START(v1, v2, v3) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_CS3_START((char)(v1), (char)(v2), (long)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_CM_AVAIL_TIME(v1) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_CM_AVAIL_TIME((long)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_CAL_RSCP(v1, v2, v3, v4, v5) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_CAL_RSCP((short)(v1), (short)(v2), (unsigned short)(v3), (short)(v4), (short)(v5));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_REQUEST_BITS(v1, v2, v3, v4, v5, v6) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_REQUEST_BITS((unsigned short)(v1), (unsigned short)(v2), (unsigned short)(v3), (unsigned short)(v4), (unsigned short)(v5), (unsigned char)(v6));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_CS_IRQ_INT(v1, v2, v3) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_CS_IRQ_INT((unsigned short)(v1), (unsigned char)(v2), (unsigned short)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_MPS_CALLBACK(v1) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_MPS_CALLBACK((char)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_RF_CONTROL(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_RF_CONTROL((unsigned long)(v1), (unsigned char)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_RF_CENTRAL_CONTROL_REG(v1, v2, v3, v4, v5, v6) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_RF_CENTRAL_CONTROL_REG((unsigned char)(v1), (unsigned short)(v2), (unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_DRX_MASK(v1, v2, v3) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_DRX_MASK((unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_SCHDL_MASK(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_SCHDL_MASK((unsigned long)(v1), (unsigned long)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_SET_CALLBACK(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_SET_CALLBACK((char)(v1), (char)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_MEAS_TID_START_LOCATION(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_MEAS_TID_START_LOCATION((char)(v1), (char)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_RSSI_ERROR(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_RSSI_ERROR((short)(v1), (short)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_CAL_AVAIL_TIME(v1, v2, v3, v4, v5, v6, v7) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_CAL_AVAIL_TIME((char)(v1), (unsigned short)(v2), (char)(v3), (unsigned short)(v4), (char)(v5), (unsigned short)(v6), (unsigned char)(v7));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_GAP_MASK(v1, v2, v3, v4, v5, v6) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_GAP_MASK((short)(v1), (short)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (short)(v6));\
} while(0)
#else
	...
	#define UL1D_TRC_CELL_STATE_CHANGE(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_CELL_STATE_CHANGE((short)(v1), (unsigned char)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_RXD_STATUS(v1) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_RXD_STATUS((unsigned char)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_RXD_DETECT_DBG(v1, v2, v3, v4, v5) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_RXD_DETECT_DBG((unsigned char)(v1), (long)(v2), (long)(v3), (long)(v4), (long)(v5));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_RXD_DETECTION_CHECK(v1, v2, v3, v4) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_RXD_DETECTION_CHECK((unsigned char)(v1), (short)(v2), (short)(v3), (unsigned short)(v4));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_RXD_DETECTION_FINAL_RESULT(v1, v2, v3) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_RXD_DETECTION_FINAL_RESULT((short)(v1), (short)(v2), (unsigned char)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_DD_STOP_PARAM(v1, v2, v3) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_DD_STOP_PARAM((long)(v1), (unsigned short)(v2), (unsigned long)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_DD_PARAM(v1, v2, v3, v4) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_DD_PARAM((char)(v1), (unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v4));\
} while(0)
#else
	...
	#define UL1D_TRC_IDLE_RFM_FRAMES(v1) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_IDLE_RFM_FRAMES((short)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_IDLE_FREE_RUN_SCHDL(v1, v2, v3, v4, v5) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_IDLE_FREE_RUN_SCHDL((unsigned char)(v1), (short)(v2), (unsigned char)(v3), (char)(v4), (unsigned short)(v5));\
} while(0)
#else
	...
	#define UL1D_TRC_IDLE_FREE_RUNNING(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_IDLE_FREE_RUNNING((char)(v1), (char)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_DD_RSSI(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_DD_RSSI((char)(v1), (short)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_FA_CELL_CORRECT(v1, v2, v3, v4) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_FA_CELL_CORRECT((unsigned short)(v1), (unsigned short)(v2), (unsigned long)(v3), (unsigned long)(v4));\
} while(0)
#else
	...
	#define UL1D_TRC_MS3_STATUS(v1) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MS3_STATUS((unsigned long)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_PROHIBIT_INTER_MEAS(v1, v2, v3) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_PROHIBIT_INTER_MEAS((char)(v1), (char)(v2), (char)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_START(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_START((char)(v1), (char)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_CS_HW_IN_USE(v1) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_CS_HW_IN_USE((unsigned short)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_CHECK_CS_TIME(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_CHECK_CS_TIME((unsigned long)(v1), (unsigned long)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_IDLE_FLAG(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_IDLE_FLAG((unsigned char)(v1), (unsigned char)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_CELL_STATE_DBG1(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_CELL_STATE_DBG1((unsigned char)(v1), (unsigned char)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_REPORT_FROM_SIB_RFM(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_REPORT_FROM_SIB_RFM((short)(v1), (short)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_MEAS_RESULT1(v1, v2, v3) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_MEAS_RESULT1((char)(v1), (short)(v2), (short)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_MEAS_RESULT2(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x04)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_MEAS_RESULT2((long)(v1), (short)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_MEAS_MEAS_MPS(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_MEAS_MEAS_MPS((char)(v1), (unsigned short)(v2), (unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6), (unsigned char)(v7), (unsigned char)(v8), (unsigned char)(v9), (unsigned char)(v10), (unsigned char)(v11), (unsigned char)(v12));\
} while(0)
#else
	...
	#define UL1D_TRC_TX_TIMING_OFFSET(v1, v2, v3) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_UL1D_TRC_TX_TIMING_OFFSET((char)(v1), (short)(v2), (unsigned char)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_TIMING_TRACKING(v1, v2, v3) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_UL1D_TRC_TIMING_TRACKING((unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_DD_RSSIDBRG(v1, v2, v3, v4) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_UL1D_TRC_DD_RSSIDBRG((short)(v1), (unsigned char)(v2), (unsigned char)(v3), (unsigned long)(v4));\
} while(0)
#else
	...
	#define UL1D_TRC_MBD_PATH_PWR_DBG(v1, v2, v3, v4, v5, v6) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_UL1D_TRC_MBD_PATH_PWR_DBG((unsigned char)(v1), (unsigned long)(v2), (unsigned short)(v3), (unsigned short)(v4), (unsigned short)(v5), (unsigned short)(v6));\
} while(0)
#else
	...
	#define UL1D_TRC_MBD_PATH_POS_DBG(v1, v2, v3, v4, v5, v6) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_UL1D_TRC_MBD_PATH_POS_DBG((unsigned char)(v1), (unsigned short)(v2), (unsigned short)(v3), (unsigned short)(v4), (unsigned short)(v5), (unsigned short)(v6));\
} while(0)
#else
	...
	#define UL1D_TRC_WIN_TRK_TAIL_HEAD(v1, v2, v3) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x08)!=0 )\
			L1TRC_Send_UL1D_TRC_WIN_TRK_TAIL_HEAD((char)(v1), (short)(v2), (short)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_WIN_TRK_PAC_ADDR(v1, v2, v3, v4) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x10)!=0 )\
			L1TRC_Send_UL1D_TRC_WIN_TRK_PAC_ADDR((unsigned short)(v1), (unsigned short)(v2), (char)(v3), (unsigned short)(v4));\
} while(0)
#else
	...
	#define UL1D_TRC_WIN_TRK_ADV_RTD(v1, v2, v3) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x10)!=0 )\
			L1TRC_Send_UL1D_TRC_WIN_TRK_ADV_RTD((unsigned char)(v1), (char)(v2), (char)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_UL_TFC_STATUS(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x20)!=0 )\
			L1TRC_Send_UL1D_TRC_UL_TFC_STATUS((unsigned long)(v1), (short)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_UL_TFC_BETA(v1, v2, v3, v4, v5, v6, v7, v8, v9) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x20)!=0 )\
			L1TRC_Send_UL1D_TRC_UL_TFC_BETA((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6), (unsigned char)(v7), (unsigned char)(v8), (short)(v9));\
} while(0)
#else
	...
	#define UL1D_TRC_UL_TFC_FRAME(v1, v2, v3, v4, v5) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x20)!=0 )\
			L1TRC_Send_UL1D_TRC_UL_TFC_FRAME((unsigned char)(v1), (unsigned char)(v2), (short)(v3), (unsigned char)(v4), (unsigned char)(v5));\
} while(0)
#else
	...
	#define UL1D_TRC_WGG_MEAS_EVENT(v1) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x80)!=0 )\
			L1TRC_Send_UL1D_TRC_WGG_MEAS_EVENT((unsigned char)(v1));\
} while(0)
#else
	...
	#define UL1D_TRC_WGG_MEAS_RTB_REQ_STATE(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x80)!=0 )\
			L1TRC_Send_UL1D_TRC_WGG_MEAS_RTB_REQ_STATE((unsigned char)(v1), (unsigned char)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_WGG_MEAS_GAP_END(v1, v2, v3) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x80)!=0 )\
			L1TRC_Send_UL1D_TRC_WGG_MEAS_GAP_END((unsigned short)(v1), (unsigned short)(v2), (unsigned short)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_WGG_3G_CHANNEL_ACTIVE(v1, v2) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x80)!=0 )\
			L1TRC_Send_UL1D_TRC_WGG_3G_CHANNEL_ACTIVE((unsigned char)(v1), (short)(v2));\
} while(0)
#else
	...
	#define UL1D_TRC_WGG_3G_Channel_Done(v1, v2, v3) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[1]&0x80)!=0 )\
			L1TRC_Send_UL1D_TRC_WGG_3G_Channel_Done((unsigned char)(v1), (short)(v2), (short)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_SFN_CELL_INVALID_CM_DATABASE(v1, v2, v3) do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[2]&0x01)!=0 )\
			L1TRC_Send_UL1D_TRC_SFN_CELL_INVALID_CM_DATABASE((short)(v1), (unsigned long)(v2), (unsigned char)(v3));\
} while(0)
#else
	...
	#define UL1D_TRC_SFN_UPDATE_CM_DATABASE() do {\
		if(UL1D_THIRD_Trace_Filter[0]==1 && (UL1D_THIRD_Trace_Filter[2]&0x01)!=0 )\
			L1TRC_Send_UL1D_TRC_SFN_UPDATE_CM_DATABASE();\
} while(0)
#else
