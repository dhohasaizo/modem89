 ...
 **************************************************************/
typedef struct _GeneralProblem
{
	kal_uint32 value;
} GeneralProblem;


typedef struct _InvokeProblem
{
	kal_uint32 value;
} InvokeProblem;


typedef struct _ReturnResultProblem
{
	kal_uint32 value;
} ReturnResultProblem;


typedef struct _ReturnErrorProblem
{
	kal_uint32 value;
} ReturnErrorProblem;


typedef struct _InvokeIdType
{
	kal_uint32 value;
} InvokeIdType;
...
typedef struct _ComponentPortion
{
