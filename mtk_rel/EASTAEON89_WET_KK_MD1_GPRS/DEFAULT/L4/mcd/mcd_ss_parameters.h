...
#define maxFTN_AddressLength 15
typedef struct _CliRestrictionOption
{
	kal_uint32 value;
...
typedef struct _OverrideCategory
{
	kal_uint32 value;
} OverrideCategory;
...
typedef struct _SS_Code
{
	kal_uint8 octs [1];
} SS_Code;


typedef struct _CCBS_Index
{
	kal_uint32 value;
} CCBS_Index;
...
typedef struct _EMLPP_Priority
{
	kal_uint32 value;
} EMLPP_Priority;


typedef struct _USSD_DataCodingScheme
{
	kal_uint8 octs [1];
} USSD_DataCodingScheme;


typedef struct _USSD_String
{
	kal_uint32 octsLen;
	kal_uint8 *octs;
} USSD_String;
...
typedef struct _USSDIA5_String
{
	kal_uint32 octsLen;
	kal_uint8 *octs;
} USSDIA5_String;
...
typedef struct _AlertingPattern
{
	kal_uint8 octs [1];
} AlertingPattern;


typedef struct _EraseCC_EntryArg
{
	SS_Code* ss_Code;
...
typedef struct _EraseCC_EntryRes
{
	SS_Code* ss_Code;
...
typedef struct _BearerServiceCode
{
	kal_uint8 octs [1];
} BearerServiceCode;


typedef struct _TeleserviceCode
{
	kal_uint8 octs [1];
} TeleserviceCode;


typedef struct _BasicServiceCode
{
	kal_uint8 dummyOpt;
...
typedef struct _BasicServiceCodeSeq
{
	kal_uint8 dummyOpt;
	BearerServiceCode* dummy;
	kal_uint8 bearerServiceOpt;
...
typedef struct _BasicServiceGroupList
{
	kal_uint32 listLen;
...
typedef struct _AddressString ISDN_AddressString;
typedef struct _ISDN_SubaddressString
{
	kal_uint32 octsLen;
	kal_uint8 *octs;
...
typedef struct _AddressString FTN_AddressString;
typedef struct _ForwardingOptions
{
	kal_uint8 octs [1];
} ForwardingOptions;


typedef struct _NoReplyConditionTime
{
	kal_uint32 value;
} NoReplyConditionTime;


typedef struct _ForwardingFeature
{
...
typedef struct _ForwardingFeatureList
{
	kal_uint32 listLen;
...
typedef struct _CCBS_FeatureList
{
	kal_uint32 listLen;
	CCBS_Feature* list [5];
} CCBS_FeatureList;
...
typedef struct _GenericServiceInfo
{
	SS_Status* ss_Status;
...
typedef struct _InterrogateSS_Res
{
	kal_uint8 ss_StatusOpt;
	SS_Status* ss_Status;
...
typedef struct _MC_Bearers
{
	kal_uint32 value;
} MC_Bearers;


#define maxNumOfMC_Bearers 7
typedef struct _RegisterSS_Arg
{
	SS_Code* ss_Code;
	kal_uint8 basicServiceOpt;
	BasicServiceCode* basicService;
	...
	kal_uint8 nbrUserOpt;
	MC_Bearers* nbrUser;
	kal_uint8 longFTN_SupportedOpt;
} RegisterSS_Arg;


typedef struct _SS_ForBS_Code
{
	SS_Code* ss_Code;
	kal_uint8 basicServiceOpt;
	BasicServiceCode* basicService;
...
typedef struct _CallBarringFeature
{
	kal_uint8 basicServiceOpt;
	BasicServiceCode* basicService;
	kal_uint8 ss_StatusOpt;
...
typedef struct _CallBarringFeatureList
{
	kal_uint32 listLen;
...
typedef struct _CallBarringInfo
{
...
typedef struct _ForwardingInfo
{
	kal_uint8 ss_CodeOpt;
	SS_Code* ss_Code;
	ForwardingFeatureList* forwardingFeatureList;
...
typedef struct _SS_SubscriptionOption
{
	kal_uint8 cliRestrictionOptionOpt;
	CliRestrictionOption* cliRestrictionOption;
...
typedef struct _CUG_Index
{
	kal_uint32 value;
} CUG_Index;


typedef struct _OperationCode
{
...
typedef struct _OperationCode CallDeflection;
typedef struct _ForwardCUG_InfoArg
{
...
typedef struct _ChargingInformation
{
	kal_uint8 e1Opt;
	E1* e1;
	kal_uint8 e2Opt;
...
typedef struct _ForwardChargeAdviceArg
{
	SS_Code* ss_Code;
...
typedef struct _SS_Notification
{
	kal_uint8 octs [1];
} SS_Notification;


typedef struct _ECT_CallState
{
	kal_uint32 value;
} ECT_CallState;
...
typedef struct _RemotePartyNumber
{
...
typedef struct _RegisterCC_EntryRes
{
	kal_uint8 ccbs_FeatureOpt;
	CCBS_Feature* ccbs_Feature;
} RegisterCC_EntryRes;
...
typedef struct _UserUserServiceArg
{
...
typedef struct _CallDeflectionArg
{
