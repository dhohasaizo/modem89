...
/****************************/
	...
	#define CH_afc_dbg(v1, v2, v3, v4) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x20)!=0 )\
	...
	#define L1D_Trc_DUAL_AFC_DAC_Sharing(v1, v2) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x20)!=0 )\
			L1TRC_Send_L1D_Trc_DUAL_AFC_DAC_Sharing((short)(v1), (unsigned char)(v2));\
} while(0)
#else
	...
	#define L1D_Trc_DUAL_AFC_MODE(v1) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x20)!=0 )\
			L1TRC_Send_L1D_Trc_DUAL_AFC_MODE((unsigned char)(v1));\
} while(0)
#else
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define L1D_Trc_IR_RESULT(v1, v2, v3) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x10)!=0 )\
			L1TRC_Send_L1D_Trc_IR_RESULT((char)(v1), (short)(v2), (short)(v3));\
} while(0)
#else
	#define L1D_Trc_IR_RESULT(v1, v2, v3)
#endif
...
void L1TRC_Send_L1D_Trc_IR_RESULT(char v1, short v2, short v3);
...
#define ChkL1ClsFltr_L1D_3RD_L1D_IRR_M()	(ChkL1ModFltr_L1D_3RD()&&((L1D_3RD_Trace_Filter[2]&0x10)!=0))
#define ChkL1ClsFltr_L1D_3RD_Dual_afc_dbg_H()	(ChkL1ModFltr_L1D_3RD()&&((L1D_3RD_Trace_Filter[2]&0x20)!=0))
#define ChkL1ClsFltr_L1D_3RD_GSM_SM_H()	(ChkL1ModFltr_L1D_3RD()&&((L1D_3RD_Trace_Filter[2]&0x40)!=0))
#define ChkL1ClsFltr_L1D_3RD_L1D_DBG_H()	(ChkL1ModFltr_L1D_3RD()&&((L1D_3RD_Trace_Filter[2]&0x80)!=0))
...
#define ChkL1MsgFltr_L1D_Trc_IR_RESULT()	ChkL1ClsFltr_L1D_3RD_L1D_IRR_M()
#define ChkL1MsgFltr_L1D_Trc_HRD_POWER_RESULT()	ChkL1ClsFltr_L1D_3RD_L1D_IRR_M()
#define ChkL1MsgFltr_L1D_Trc_HRD_RESULT()	ChkL1ClsFltr_L1D_3RD_L1D_IRR_M()
