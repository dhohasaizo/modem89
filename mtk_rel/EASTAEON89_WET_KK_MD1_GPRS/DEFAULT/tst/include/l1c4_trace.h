...
/****************************/
	...
	#define RTB_Trace_3_GSM(v1, v2, v3, v4, v5) do {\
		if(L1C_GPRS2_Trace_Filter[0]==1 && (L1C_GPRS2_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_RTB_Trace_3_GSM((char)(v1), (long)(v2), (unsigned char)(v3), (unsigned short)(v4), (long)(v5));\
} while(0)
#else
	...
	#define RTB_Trace_3_UMTS(v1, v2, v3, v4, v5) do {\
		if(L1C_GPRS2_Trace_Filter[0]==1 && (L1C_GPRS2_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_RTB_Trace_3_UMTS((char)(v1), (long)(v2), (unsigned char)(v3), (unsigned short)(v4), (long)(v5));\
} while(0)
#else
	...
	#define RTB_Trace_8_GSM(v1, v2, v3) do {\
		if(L1C_GPRS2_Trace_Filter[0]==1 && (L1C_GPRS2_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_RTB_Trace_8_GSM((unsigned char)(v1), (long)(v2), (long)(v3));\
} while(0)
#else
	...
	#define RTB_Trace_8_UMTS(v1, v2, v3) do {\
		if(L1C_GPRS2_Trace_Filter[0]==1 && (L1C_GPRS2_Trace_Filter[1]&0x02)!=0 )\
			L1TRC_Send_RTB_Trace_8_UMTS((unsigned char)(v1), (long)(v2), (long)(v3));\
} while(0)
#else
	...
	#define RTB_Trace_9_GSM(v1, v2, v3) do {\
		if(L1C_GPRS2_Trace_Filter[0]==1 && (L1C_GPRS2_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_RTB_Trace_9_GSM((unsigned char)(v1), (long)(v2), (long)(v3));\
} while(0)
#else
	...
	#define RTB_Trace_9_UMTS(v1, v2, v3) do {\
		if(L1C_GPRS2_Trace_Filter[0]==1 && (L1C_GPRS2_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_RTB_Trace_9_UMTS((unsigned char)(v1), (long)(v2), (long)(v3));\
} while(0)
#else
	...
	#define RTB_Trace_11_GSM(v1, v2) do {\
		if(L1C_GPRS2_Trace_Filter[0]==1 && (L1C_GPRS2_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_RTB_Trace_11_GSM((unsigned char)(v1), (long)(v2));\
} while(0)
#else
	...
	#define RTB_Trace_11_UMTS(v1, v2) do {\
		if(L1C_GPRS2_Trace_Filter[0]==1 && (L1C_GPRS2_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_RTB_Trace_11_UMTS((unsigned char)(v1), (long)(v2));\
} while(0)
#else
	...
	#define RTB_Trace_13(v1, v2) do {\
		if(L1C_GPRS2_Trace_Filter[0]==1 && (L1C_GPRS2_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_RTB_Trace_13((long)(v1), (long)(v2));\
} while(0)
#else
	...
	#define RTB_Trace_14_UMTS(v1, v2) do {\
		if(L1C_GPRS2_Trace_Filter[0]==1 && (L1C_GPRS2_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_RTB_Trace_14_UMTS((long)(v1), (long)(v2));\
} while(0)
#else
	...
	#define RTB_Trace_22_GSM(v1, v2, v3, v4, v5, v6, v7) do {\
		if(L1C_GPRS2_Trace_Filter[0]==1 && (L1C_GPRS2_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_RTB_Trace_22_GSM((unsigned char)(v1), (long)(v2), (long)(v3), (unsigned char)(v4), (long)(v5), (unsigned char)(v6), (long)(v7));\
} while(0)
#else
	...
	#define RTB_Trace_22_UMTS(v1, v2, v3, v4, v5, v6, v7) do {\
		if(L1C_GPRS2_Trace_Filter[0]==1 && (L1C_GPRS2_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_RTB_Trace_22_UMTS((unsigned char)(v1), (long)(v2), (long)(v3), (unsigned char)(v4), (long)(v5), (unsigned char)(v6), (long)(v7));\
} while(0)
#else
	...
	#define RTB_Trace_28_GSM(v1, v2, v3, v4) do {\
		if(L1C_GPRS2_Trace_Filter[0]==1 && (L1C_GPRS2_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_RTB_Trace_28_GSM((long)(v1), (unsigned char)(v2), (unsigned short)(v3), (long)(v4));\
} while(0)
#else
	...
	#define RTB_Trace_28_UMTS(v1, v2, v3, v4) do {\
		if(L1C_GPRS2_Trace_Filter[0]==1 && (L1C_GPRS2_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_RTB_Trace_28_UMTS((long)(v1), (unsigned char)(v2), (unsigned short)(v3), (long)(v4));\
} while(0)
#else
	...
	#define RTB_Trace_36(v1, v2, v3, v4) do {\
		if(L1C_GPRS2_Trace_Filter[0]==1 && (L1C_GPRS2_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_RTB_Trace_36((unsigned char)(v1), (long)(v2), (long)(v3), (unsigned char)(v4));\
} while(0)
#else
...
void L1TRC_Send_RTB_Trace_3_GSM(char v1, long v2, unsigned char v3, unsigned short v4, long v5);
void L1TRC_Send_RTB_Trace_4_GSM(unsigned char v1, long v2, char v3, long v4, long v5);
void L1TRC_Send_RTB_Trace_3_UMTS(char v1, long v2, unsigned char v3, unsigned short v4, long v5);
...
void L1TRC_Send_RTB_Trace_8_GSM(unsigned char v1, long v2, long v3);
void L1TRC_Send_RTB_Trace_8_UMTS(unsigned char v1, long v2, long v3);
...
void L1TRC_Send_RTB_Trace_28_GSM(long v1, unsigned char v2, unsigned short v3, long v4);
void L1TRC_Send_RTB_Trace_28_UMTS(long v1, unsigned char v2, unsigned short v3, long v4);
