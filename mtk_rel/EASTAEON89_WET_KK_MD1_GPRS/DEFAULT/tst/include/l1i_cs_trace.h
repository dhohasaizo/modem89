...
/****************************/
	...
	#define L1I_Msg_Timer(v1, v2, v3, v4, v5) do {\
		if(L1I_GSM_Trace_Filter[0]==1 && (L1I_GSM_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_L1I_Msg_Timer((unsigned char)(v1), (char)(v2), (char)(v3), (unsigned char)(v4), (unsigned short)(v5));\
} while(0)
#else
	...
	#define L1C_Msg_SIMTiming(v1, v2, v3, v4, v5) do {\
		if(L1I_GSM_Trace_Filter[0]==1 && (L1I_GSM_Trace_Filter[2]&0x40)!=0 )\
			L1TRC_Send_L1C_Msg_SIMTiming((unsigned char)(v1), (char)(v2), (unsigned long)(v3), (short)(v4), (short)(v5));\
} while(0)
#else
	...
	#define L1I_Msg_TimerNoExecute(v1, v2, v3, v4, v5, v6) do {\
		if(L1I_GSM_Trace_Filter[0]==1 && (L1I_GSM_Trace_Filter[1]&0x01)!=0 )\
			L1TRC_Send_L1I_Msg_TimerNoExecute((unsigned char)(v1), (unsigned char)(v2), (char)(v3), (char)(v4), (char)(v5), (char)(v6));\
} while(0)
#else
...
void L1TRC_Send_L1I_Msg_Timer(unsigned char v1, char v2, char v3, unsigned char v4, unsigned short v5);
...
void L1TRC_Send_L1C_Msg_SIMTiming(unsigned char v1, char v2, unsigned long v3, short v4, short v5);
