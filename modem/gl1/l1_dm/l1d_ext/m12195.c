...
#elif IS_RF_MT6140D || IS_RF_AD6548 || IS_RF_AD6546 || IS_RF_MT6280RF || IS_RF_MT6167
...
/*MT6280RF*/    SETUP_SR1();
/*MT6280RF*/
/*MT6280RF*/    HWRITE_12_SDATA( SCTRL_DCO_MAN,                SDATA_DCO_MAN,                     /* CW23 : DC Offset Manual mode */
...
/*MT6280RF*/    unsigned short DEM_Chunk_L1 = 0;
/*MT6280RF*/    unsigned short Nint         = 0;
/*MT6280RF*/    unsigned long  Nfrac        = 0;
/*MT6280RF*/    long  cw34,cw80,cw97,cw98,cw79,cw75;
/*MT6280RF*/    #if IS_CHIP_MT6280_S00
/*MT6280RF*/    long  cw33;
/*MT6280RF*/    #else
...
/*MT6280RF*/    DEM_Chunk_L1 = L1D_RF_GetTxDEMChunkSetting( l1d_rf.band, Nint );
/*MT6280RF*/
/*MT6280RF*/    #if IS_CHIP_MT6280_S00
...
/*MT6280RF*/    cw79 = (long) (POR_CW79 | (DEM_Chunk_L1&0x7F)<<2);
/*MT6280RF*/    cw75 = (long) (POR_CW75);
/*MT6280RF*/
/*MT6280RF*/    #if IS_CHIP_MT6280_S00
/*MT6280RF*/    HWRITE_12_SDATA( SCTRL_CURRENT_CONTROL, SDATA_CURRENT_CONTROL_ON,  /* CW245: Add always on current control */
...
/*MT6280RF*/                     SCTRL_PLL,             BSI_CW(0x4F, cw79),        /* CW79 : STX_DEM_chunk [6:0] */
...
/*MT6280RF*/    #else
/*MT6280RF*/    HWRITE_12_SDATA( SCTRL_CKG_LDO_RCODE,   BSI_CW(0x9 , cw9  ),        /* CW9  : [D5:D3]=001,Changed it for spur improvement */
