 ...
 *
 * 04 19 2013 ola.lee
 * [MOLY00020333] The phone works incorrectly with some MTS SIM-cards 有??出?卡掉网
 * .
 *
...
typedef  struct
{
   ...
   char           is_txiqmm_iteration_support;
#endif
#if IS_TX_POWER_CONTROL_SUPPORT
   TXPC_MODE      txpc_mode;
   TXPC_TYPE      txpc_type;
...
{
   int            arfcn;
#if IS_EPSK_TX_SUPPORT || IS_RF_MT6162 || IS_RF_MT6163 || IS_RF_MT6280RF || IS_RF_MT6167
   ...
   signed short   tx_dc_meas_i[4][7];   /* the maximum calibration times is 7                        */
   signed short   tx_dc_meas_q[4][7];   /* the maximum calibration times is 7                        */
   signed short   tx_dc_avg_i[4][16];   /* [Band][PCL]                                               */
   signed short   tx_dc_avg_q[4][16];   /* [Band][PCL]                                               */
         #else
   ...
   #elif IS_RF_MT6256RF || IS_RF_MT6280RF || IS_RF_MT6167
      #if IS_EPSK_TX_SUPPORT
   unsigned short tx_gain_setting[TXPC_SLOT_MAX];
      #endif
   #endif
...
#if IS_RF_MT6256RF || IS_RF_MT6251RF || IS_RF_MT6255RF || IS_RF_MT6280RF || IS_RF_MT6167
...
/*    BSI codeword marco                                                         */
/*===============================================================================*/
#if IS_CHIP_MT6256 || IS_CHIP_MT6251 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1
