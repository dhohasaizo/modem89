...
//#include "keypad_sw.h"
//#include "l4c2uem_struct.h"     //mtk00468 add for RTC format refer 100103
//#include "device.h"
#include "l4c_eq_msg.h"
#include "l4c_nw_msg.h"
#include "l4c_phb_msg.h"
#include "l4c_sat_msg.h"
#include "l4c_sim_msg.h"
#include "l4c_sms_msg.h"
#include "l4c_dt_msg.h"

#ifdef __MOD_TCM__
#include "l4c_gprs_msg.h"
#endif 
#ifdef __CSD_FAX__
#include "l4c_t30_msg.h"
#endif 
//#include "uart_sw.h"
#include "l4c_tst.h"
...
L4C_MSG_FUNCTION const l4c_cnf_ft[] = 
{
    #define L4C_REQ(MSG, HDLR)
    #define L4C_CNF(MSG, HDLR)  HDLR,
...
L4C_MSG_FUNCTION const l4c_ind_ft[] = 
{
    #define L4C_REQ(MSG, HDLR)
    #define L4C_CNF(MSG, HDLR)
    #define L4C_IND(MSG, HDLR)  HDLR,
        #include "l4c_msg_hdlr_defs.h"
    #undef L4C_REQ
    #undef L4C_CNF
    #undef L4C_IND
...
#ifdef __TCPIP__
L4C_MSG_FUNCTION const l4c_req_ft[] = 
{
    #define L4C_REQ(MSG, HDLR)  HDLR,
    #define L4C_CNF(MSG, HDLR)
    #define L4C_IND(MSG, HDLR)
        #include "l4c_msg_hdlr_defs.h"
    #undef L4C_REQ
