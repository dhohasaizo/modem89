...
extern void rac_send_dereg_cnf(void);
...
extern void rac_handle_class_change(ms_mobile_class_enum prev_ms_class);
...
extern void rac_send_class_change_cnf(void);
...
extern void rac_copy_rac_perference(kal_uint8 *pdu_ptr);
...
extern kal_bool is_rac_gmm_state_null_dereg(void);
extern kal_bool is_rac_gmm_state_reg(void);
extern l4c_rac_gprs_status_enum rac_get_gprs_status(void);
extern reg_state_enum rac_get_gprs_state(void);

extern void rac_l4c_reg_req_cs(kal_bool *req_needed, kal_bool *response);
extern void rac_l4c_reg_req_ps(kal_bool *req_needed, kal_bool *response);
