...
sub GetPath
{
    ...
    my $strTemplateFolder = "./custom/system/Template/$LDSFolderName/";
    ...
    elsif($nType == RegionList)
    {
        ...
        $strPath = $strTemplateFolder.$PathMap{RegionList}."RegionList.csv" if(!-e $strPath);
    }
...
sub PreProcessRegionList
{
    ...
    my $RegionList_ref = &{$Func{SetRegionList}}($BasicRegionList_ref, $Index_ref, $MEMORYSetting_href);
