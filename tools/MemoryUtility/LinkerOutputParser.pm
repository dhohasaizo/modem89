...
sub ListAllExeRegion
{
	...
	{
		$ExeRegion_aref = &SymFileParser::ListAllExeRegion;
	}
...
#                              Object Name should contain ".obj"
#                              $strCategory: RO Data/RW Data/ZI Data/RWZI Data/Code
...
sub GetObjSizeByCatExeRegion
{
	...
	my $n_size;
	die "Object name must contain .obj/.o postfix\n" if ($strObjName !~ /\.o/);
	die "Category should be RO Data/RW Data/ZI Data/RWZI Data/Code\n" if (($strCategory ne "RO Data") && ($strCategory ne "RW Data") && ($strCategory ne "ZI Data") && ($strCategory ne "RWZI Data") && ($strCategory ne "Code"));
	if($strFileType eq "LIS")
	{
...
sub Get_CACHED_DUMMY_END_Size
{
	...
	if($strFileType eq "LIS")
	{
		$CACHED_DUMMY_END_size = undef;
	}
	elsif($strFileType eq "SYM")
	{
		$CACHED_DUMMY_END_size = &SymFileParser::Get_CACHED_DUMMY_END_Size;
	}
...
sub Get_CACHED_DUMMY_END_Base
{
	...
	if($strFileType eq "LIS")
	{
		$CACHED_DUMMY_END_base = undef;
	}
	elsif($strFileType eq "SYM")
	{
		$CACHED_DUMMY_END_base = &SymFileParser::Get_CACHED_DUMMY_END_Base;
	}
