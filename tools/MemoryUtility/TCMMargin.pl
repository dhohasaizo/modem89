...
#****************************************************************************
# subroutine:  CalcTCMmargine - calculate TCM margine
# Input:       x
# Output:      x
#****************************************************************************
sub CalcTCMmargine
{
    ...
    {
        print "$strRegionname physical size = ". $TCMmargin_href->{$strRegionname}->[0]."(Bytes) $strRegionname margin = ". $TCMmargin_href->{$strRegionname}->[1]."(Bytes)\n";
    }
}
