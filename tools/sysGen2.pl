...
__attribute__ ((zero_init, section ("INTERNZI"))) static EXTSRAM_REGION_INFO_T DYNAMIC_CACHED_EXTSRAM_DNC_REGION[$DYNAMIC_DNC_Count];
__attribute__ ((zero_init, section ("INTERNZI"))) static EXTSRAM_REGION_INFO_T DYNAMIC_CACHED_EXTSRAM_DC_REGION[$DYNAMIC_DC_Count];
__attribute__ ((zero_init, section ("INTERNZI"))) static EXTSRAM_REGION_INFO_T CACHED_EXTSRAM_REGION[$CACHED_RW_Count];
__attribute__ ((zero_init, section ("INTERNZI"))) static EXTSRAM_REGION_INFO_T CACHED_EXTSRAM_CODE_REGION[$CACHED_RO_Count];
__attribute__ ((zero_init, section ("INTERNZI"))) static EXTSRAM_REGION_INFO_T NONCACHED_EXTSRAM_REGION[$NONCACHED_RW_Count];
__attribute__ ((zero_init, section ("INTERNZI"))) static EXTSRAM_REGION_INFO_T NONCACHED_EXTSRAM_RO_REGION[$NONCACHED_RO_Count];
__attribute__ ((zero_init, section ("INTERNZI"))) static EXTSRAM_REGION_INFO_T CACHED_EXTCODE_REGION[$EXTCODE_Count];
__TEMPLATE
}
sub SCAT_C_Gen_ARRAY_MULTIROM_REGION
{
    ...
    my $template = <<"__TEMPLATE";
__attribute__ ((zero_init, section ("INTERNZI"))) static EXTSRAM_REGION_INFO_T MULTI_ROM_LOAD_REGION[$MULTIROM_Count];
__TEMPLATE
}
sub SCAT_C_Gen_ARRAY_DSP_SHARE_REGION
{
    ...
    my $template = <<"__TEMPLATE";
__attribute__ ((zero_init, section ("INTSRAM_ZI"))) static EXTSRAM_REGION_INFO_T MCU_C_DSP_C_REGION[$MCU_C_DSP_C_Count];
__attribute__ ((zero_init, section ("INTSRAM_ZI"))) static EXTSRAM_REGION_INFO_T MCU_C_DSP_NC_REGION[$MCU_C_DSP_NC_Count];
__attribute__ ((zero_init, section ("INTSRAM_ZI"))) static EXTSRAM_REGION_INFO_T MCU_NC_DSP_C_REGION[$MCU_NC_DSP_C_Count];
__attribute__ ((zero_init, section ("INTSRAM_ZI"))) static EXTSRAM_REGION_INFO_T MCU_NC_DSP_NC_REGION[$MCU_NC_DSP_NC_Count];
__TEMPLATE
    return $template;
}
...
{
    return "    MCU_C_DSP_C_REGION[0].addr = MCU_C_DSP_C_REGION[0].len = 0;";
}
