...
/*************************************************************************
 * Power off Detach procedure will finish within MM_CS_PS_POWER_OFF_TIMER_PERIOD.
 * Customization can be done here. Config the CS_PS_POWER_OFF timer value as below. 
 * The minimum timer value should be 10 Seconds.
 *************************************************************************/
/* default value: 20 Seconds */ 
const kal_uint32 MM_CS_PS_POWER_OFF_TIMER_PERIOD = 20 * KAL_TICKS_1_SEC;
